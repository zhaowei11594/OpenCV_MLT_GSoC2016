...
@add_toggle{Button 1 Name}

 text/code/image for button 1 

@add_toggle{Button 2 Name}

 text/code/image for button 2 
...
### Toggle buttons inclusion {#tutorial_documentation_buttons_include}

To add toggle buttons in documentation, add_toggle and end_toggle_zone custom commands are used. 
...
Produces documentation toggle zone looking like this:
